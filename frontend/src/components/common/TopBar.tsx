    ...
    <div className="flex items-center gap-3 px-6 pt-5 pb-3">
      ...
      <div className="ml-6 flex-1 max-w-xl relative">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2 rounded-lg bg-white/5 ring-1 ring-white/10 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-indigo-400/50"
        />
      </div>
      <div className="ml-auto flex items-center gap-2">
        <button className="p-2 rounded-lg bg-white/5 hover:bg-white/10 ring-1 ring-white/10 relative">
          <Bell className="w-4 h-4 text-slate-300" />
        </button>
        <div className="flex items-center gap-2 pl-3 pr-2 py-1.5 rounded-lg bg-white/5 ring-1 ring-white/10">
          ...
          <div className="text-xs leading-tight">
            ...
            <div className="text-slate-400 text-[10px]">Sr. Underwriter · L3</div>
          </div>
        </div>
      </div>
    </div>
